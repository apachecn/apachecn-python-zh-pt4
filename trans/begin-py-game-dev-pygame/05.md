...
![Image](../Images/image00327.jpeg) **注意**如果你没有使用 Python 3+一定要除以一个浮点值 1000.0。如果不包括浮点，结果将向下舍入到最接近的整数！
...
![Image](../Images/image00327.jpeg) **注意**虽然写得好的游戏在低帧率下仍然可以玩，但如果运动太不稳定，人们就会失去玩游戏的兴趣。就我个人而言，我不想玩一个运行速度远低于每秒 15 帧的游戏，它会变得非常令人迷惑！
...
![9781484209714_Fig05-01.jpg](../Images/image00336.jpeg)
...
![9781484209714_Fig05-02.jpg](../Images/image00337.jpeg)
...
![9781484209714_Fig05-03.jpg](../Images/image00338.jpeg)
...
![Image](../Images/image00327.jpeg) **注意**如果你使用列表或元组来存储你的向量，不要试图用+运算符把它们加在一起。在 Python 中(1，2)+(3，4)是*不是* (4，6)；实际上是(1，2，3，4)，这不是一个有效的 2D 向量。
...
![9781484209714_Fig05-04.jpg](../Images/image00339.jpeg)

[图 5-4](#_Fig4) 。将一个向量乘以一个标量

![Image](../Images/image00327.jpeg) **注意**一个向量乘以另一个向量也是可能的，但是在游戏中并不常用，你可能永远也不会需要它。
