...
![Image](../Images/image00327.jpeg) **注意**一些显卡确实能够使用不是 2 的幂的纹理，但是为了最大的兼容性，最好坚持 2 的幂。
...
![Image](../Images/image00327.jpeg) **注意**纹理`id` s 是整数值，而不是物体。删除纹理`id`，或者让它超出范围，都不会清理纹理。你应该手动删除你不想再使用的纹理(稍后见“删除纹理”一节)。
...
![9781484209714_Fig11-01.jpg](../Images/image00372.jpeg)
...
![Image](../Images/image00327.jpeg) **注意**一些 3D APIs、工具、书籍将纹理坐标称为 u 和 v，而不是 s 和 t
...
![9781484209714_Fig11-02.jpg](../Images/image00373.jpeg)
...
![9781484209714_Fig11-03.jpg](../Images/image00374.jpeg)

[图 11-3](#_Fig3) 。Mip 地图

![Image](../Images/image00327.jpeg) **注** Mip 是 parvo 中 *multum 的首字母缩略词，拉丁语意为“小空间中的多”*
...
![9781484209714_Fig11-04.jpg](../Images/image00375.jpeg)
...
![Image](../Images/image00327.jpeg) **提示**拼贴最适用于被设计为无缝的纹理——也就是说，如果你将它们并排放置，你就看不到其中一个结束，另一个开始。
...
![Image](../Images/image00327.jpeg) **提示**很多游戏开发者都会发布他们游戏中使用的 3D 模型格式。你可以用商业游戏中的角色来测试你的游戏——但是要小心违反版权法！
...
![9781484209714_Fig11-05.jpg](../Images/image00376.jpeg)
...
![Image](../Images/image00327.jpeg) **注意**为了简单起见，Model3D 类只处理包含三角形的 OBJ 文件。如果您的模型包含四边形或其他多边形，您将需要使用 3D 建模器将其转换为三角形。
...
![Image](../Images/image00327.jpeg) **注意**手动调用`free_resources`函数是个好主意，因为如果 Python 在 PyOpenGL 退出后清理 Model3D 对象，可能会导致错误。
...
![9781484209714_Fig11-06.jpg](../Images/image00377.jpeg)

图 11-6 。加油示范 py

![Image](../Images/image00327.jpeg) **注意**并非所有的 3D modeler 应用程序都使用相同的比例。如果您发现您的模型非常大或非常小，您可能需要在导出之前对其进行缩放，或者更改代码以在不同的距离查看对象。
