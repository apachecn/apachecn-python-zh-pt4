...
![Table4-1.jpg](../Images/image00335.jpeg)
...
![Image](../Images/image00327.jpeg) **注意**如果你用其他方法在整个屏幕上绘图，你不需要调用`fill`来清除。
...
![Image](../Images/image00327.jpeg) **注意**`get_at`方法从硬件表面读取时会非常慢。显示器可以是一个硬件表面，尤其是在全屏运行的情况下，因此您可能应该避免获取显示器的像素。
...
![Image](../Images/image00327.jpeg) **注意**要锁定的呼叫数量应该与要解锁的呼叫数量相同。如果你忘记解锁一个表面，Pygame 可能会变得没有反应。
