...
<colgroup><col class="tcol1 align-left"> <col class="tcol2 align-left"></colgroup> 
| ⑩ | WinSCP 也是另一个在连接到 FTP 服务器进行文件管理时很方便的 Windows 应用。在主机的 Windows 操作系统和 CentOS 8 Linux 服务器之间上传或下载。参见图 [8-5](#Fig5) 和图 [8-6](#Fig6) 。您可以从以下 URL 免费下载 WinSCP:URL: [`https://winscp.net/eng/download.php`](https://winscp.net/eng/download.php) |
