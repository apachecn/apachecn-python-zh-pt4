...
![../images/492721_1_En_8_Chapter/492721_1_En_8_Figa_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Figa_HTML.jpg)
...
| ⑧ | 如果 FTP 服务工作正常，您应该打开您最喜欢的 web 浏览器，并使用服务器的`ftp://SERVER_IP_ADDRESS`打开 FTP 页面。如果提示您输入用户 ID 和密码，请输入您的详细信息。见图 [8-3](#Fig3) 。`ftp://192.168.183.130/`![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig3_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig3_HTML.jpg)图 8-3。CentOS FTP 服务器，FTP 在 Firefox web 浏览器中打开 |
...
![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig6_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig6_HTML.jpg)

图 8-6。

WinSCP，连接到 CentOS FTP 服务器

![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig5_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig5_HTML.jpg)
...
![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig4_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig4_HTML.jpg)
...
![../images/492721_1_En_8_Chapter/492721_1_En_8_Figc_HTML.gif](../images/492721_1_En_8_Chapter/492721_1_En_8_Figc_HTML.gif)使用`find`命令确定包含文件或目录名的目录或文件位置。在下面的例子中，我们寻找的是`pub`目录，它通常是`./var/ftp/`目录下的`ftp`默认目录。
...
| ⑧ | 使用以下命令检查端口 22 和`sshd`是否正常工作(参见图 [8-7](#Fig7) ):`[root@centos8s1 ~]# netstat -ap &#124; grep sshd``[root@centos8s1 ~]# netstat -tupan &#124; grep 22``[root@centos8s1 ~]# netstat -na &#124; grep tcp6`![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig7_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig7_HTML.jpg)图 8-7。CentOS，netstat -tupan &#124; grep 22 示例 |
| ⑵ | Finally, verify that your SFTP server is working correctly. You can use Windows applications such as FileZilla or WinSCP with user ID `sftpuser`, your password, and connecting port 22\. See Figure [8-8](#Fig8) and Figure [8-9](#Fig9).![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig8_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig8_HTML.jpg)图 8-8。FileZilla 客户端连接示例![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig9_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig9_HTML.jpg)图 8-9。WinSCP，SFTP 连接示例 |

![../images/492721_1_En_8_Chapter/492721_1_En_8_Figd_HTML.gif](../images/492721_1_En_8_Chapter/492721_1_En_8_Figd_HTML.gif) **如何打印出 Linux 服务器上配置的所有用户名？**
...
![../images/492721_1_En_8_Chapter/492721_1_En_8_Fige_HTML.gif](../images/492721_1_En_8_Chapter/492721_1_En_8_Fige_HTML.gif)您可以使用`net-tool`来检查 TFTP 是否正常工作。如果您的 CentOS VM 不识别`netstat`命令，您可以使用`yum install -y net-tool`来安装它，并运行以下一组命令来检查与 TFTP 相关的端口操作:
...
&#124; udp6 &#124; Zero &#124; Zero &#124; :::5353 &#124; :::* &#124;   &#124;
 ...
 |
| ④ | 您还可以使用带有参数的`ss`命令来查看监听端口或端口准备情况。要查看一个程序或进程是否正在监听一个端口，准备接受一个包，使用`ss`。`ss`命令可以在 Ubuntu 和 CentOS 服务器上运行。参见图 [8-12](#Fig12) 。`t`—显示 TCP 套接字`u`—显示 UDP 套接字`l`—显示监听插座`n`—不解析名称`p`—使用套接字显示过程`[root@centos8s1 ~]# ss –nutlp`运筹学`root@ubuntu20s1:~# ss -nutlp`![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig12_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig12_HTML.jpg)图 8-12。Ubuntu–ss–nutlp 示例 |
| ⑤号 | 使用`lsof`列出 Linux 操作系统上开放的端口。要列出进程名和 PID 号以及打开的端口，请键入`lsof –i`。您可以在大多数 Linux 操作系统上使用这个命令。见图 [8-13](#Fig13) 。`[root@centos8s1 ~]# lsof –i`运筹学`root@ubuntu20s1:~# lsof -i`![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig13_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig13_HTML.jpg)图 8-13。Ubuntu–lsof–I 示例 |
| ⑥ | 使用`iptables`命令列出更多的 TCP/IP 通信信息。运行`iptables -xvn –L`显示数据包、接口、源和目的 IP 地址以及正在使用的端口。见图 [8-14](#Fig14) 。`root@ubuntu20s1:~# iptables -xvn –L`运筹学`[root@centos8s1 ~]# iptables -xvn -L`![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig14_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig14_HTML.jpg)图 8-14。CentOS，iptables-xvn–L 示例 |
| ① | 也许您正在从 Windows 客户端连接到您的 FTP 服务器。那么，你如何从你的 Windows 电脑与你的 FTP 服务器建立 FTP 连接呢？您可以使用 Windows 命令行提示符或 Windows PowerShell。`Test-NetConnection`是一个本地 PowerShell 命令，可用于测试简单的连接，如 FTP 端口 21。让我们从您的 Windows 10 主机 PC/笔记本电脑启动 PowerShell，快速测试与 CentOS FTP 服务器的 FTP 连接是否正常工作。参见图 [8-15](#Fig15) 。PS C:\Users\brendan> `test-NetConnection -ComputerName 192.168.183.130 -Port 21`![../images/492721_1_En_8_Chapter/492721_1_En_8_Fig15_HTML.jpg](../images/492721_1_En_8_Chapter/492721_1_En_8_Fig15_HTML.jpg)图 8-15。Windows 10 主机 PC，PowerShell 测试-网络连接示例 |
