...
![img/492721_1_En_7_Figa_HTML.jpg](img/492721_1_En_7_Figa_HTML.jpg)本章没有安装前任务，但本章假设您已经阅读并完成了第[1](01.html)–[3](03.html)章节。您将使用之前章节中安装的 Ubuntu Server 20 LTS 和 CentOS 8.1 虚拟服务器。如果您尚未完成这些安装，请返回到前面的章节并创建您的虚拟机。您可以从以下 GitHub 网站下载其他安装指南:
...
![img/492721_1_En_7_Figc_HTML.gif](img/492721_1_En_7_Figc_HTML.gif)图 [7-2](#Fig2) 显示了一个典型的 Linux 目录结构。不同的 Linux 类型会有稍微不同的目录和文件结构，但是通常彼此是相同的。
